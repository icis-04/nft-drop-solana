...
export default function Main() {
  ...
  // set up state in Candy machine and update it every few seconds
  ...
  candyState.candyGuard.guards.solPayment.lamports.toNumber() / LAMPORTS_PER_SOL 
  : null;
  ...
  return (
    <div className={styles.wrapper}>
      ...
      />
      <Head>
        <title>Home | Solana Bored Ape NFT</title>
      </Head>
